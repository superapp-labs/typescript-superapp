...
The superapp client exposes standard Drizzle ORM query methods. All methods return promises and queries are executed via [Drizzle Proxy](https://orm.drizzle.team/docs/connect-drizzle-proxy).
