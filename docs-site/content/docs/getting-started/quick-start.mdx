...
<Callout type="info">
**Deploying to edge?** Add `executor: 'direct'` to skip DuckDB and use native database drivers. Everything else stays the same. See [Direct Connections](/docs/advanced/direct-connections).
</Callout>
