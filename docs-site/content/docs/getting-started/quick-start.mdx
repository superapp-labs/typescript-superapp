...
- [Backend Configuration](/docs/backend) — Full reference for `createEngine` options, connections, and security settings.
- [Client Queries](/docs/client/queries) — All query methods: `db.select()`, `db.insert()`, `db.update()`, `db.delete()`.
- [Permissions](/docs/backend/permissions/where) — Where clauses, validation, defaults, overwrite, and middleware.
