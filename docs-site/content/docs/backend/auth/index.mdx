...
Any property you return becomes available as a `$user.*` variable in [where clauses](/docs/backend/permissions/where), [validate](/docs/backend/permissions/validate), and [defaults & overwrite](/docs/backend/permissions/defaults).
