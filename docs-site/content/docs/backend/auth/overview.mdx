...
Any property you return becomes available as a `$user.*` variable in [filters](/docs/backend/permissions/filters), [checks](/docs/backend/permissions/checks), and [presets](/docs/backend/permissions/presets).
