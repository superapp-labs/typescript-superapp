...
- [PostgreSQL](/docs/integrations/postgres) -- Full CRUD with Postgres
- [MySQL](/docs/integrations/mysql) -- Full CRUD with MySQL
- [SQLite](/docs/integrations/sqlite) -- Local file-based databases
- [CSV](/docs/integrations/csv) -- Read-only CSV file queries
- [Custom Providers](/docs/integrations/custom-provider) -- Build your own provider
