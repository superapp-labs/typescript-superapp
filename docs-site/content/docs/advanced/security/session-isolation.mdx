...
All data access goes through the engine's query builder, which generates SQL from the validated JSON request. Users cannot inject or execute arbitrary SQL.
