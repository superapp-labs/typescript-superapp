...
```text
  Browser / Frontend
  ┌─────────────────────────────────────────┐
  │  AuthCard (sign-in, sign-up)            │──── POST /auth/* ────┐
  │  drizzle() — Drizzle ORM client         │──── POST /data + JWT ┐│
  └─────────────────────────────────────────┘                      ││
                                                                   ││
  @superapp/backend                                                ▼▼
  ┌─────────────────────────────────────────┐
  │  HTTP Adapter (Hono / Express / Next.js)│
  │    │                                    │
  │    ▼                                    │
  │  Auth Layer (better-auth / custom)      │
  │    │                                    │
  │    ▼                                    │
